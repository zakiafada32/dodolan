...
func (_m *Service) CreateNew(_a0 product.Product) error {
	ret := _m.Called(_a0)
...
func (_m *Service) FindAll() ([]product.ProductAtt, error) {
	ret := _m.Called()
...
func (_m *Service) FindByCategory(categoryId uint32) ([]product.ProductAtt, error) {
...
func (_m *Service) FindById(id uint32) (product.ProductAtt, error) {
	ret := _m.Called(id)
...
func (_m *Service) Update(id uint32, updateData product.Product) (product.ProductAtt, error) {
