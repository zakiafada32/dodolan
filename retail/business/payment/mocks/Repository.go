...
func (_m *Repository) CreateNew(provider payment.PaymentProvider) error {
...
func (_m *Repository) FindAll() ([]payment.PaymentProvider, error) {
	ret := _m.Called()
...
func (_m *Repository) Update(id uint32, name string, description string) (payment.PaymentProvider, error) {
