...
func (_m *Service) CreateNew(courierProvider courier.CourierProvider) error {
...
func (_m *Service) FindAll() ([]courier.CourierProvider, error) {
	ret := _m.Called()
...
func (_m *Service) Update(id uint32, name string, description string) (courier.CourierProvider, error) {
