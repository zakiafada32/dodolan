...
func (_m *Service) Courier(userId string, orderId uint32) error {
...
func (_m *Service) FindAll(userId string) ([]order.Order, error) {
...
func (_m *Service) FindById(userId string, orderId uint32) (order.Order, error) {
	ret := _m.Called(userId, orderId)
...
func (_m *Service) Payment(userId string, orderId uint32, totalAmount uint64) error {
