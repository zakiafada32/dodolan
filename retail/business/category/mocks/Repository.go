...
func (_m *Repository) CreateNew(_a0 category.Category) error {
	ret := _m.Called(_a0)
...
func (_m *Repository) FindAll() ([]category.Category, error) {
	ret := _m.Called()
...
func (_m *Repository) FindById(id uint32) (category.Category, error) {
	ret := _m.Called(id)
...
func (_m *Repository) Update(id uint32, name string, description string) (category.Category, error) {
